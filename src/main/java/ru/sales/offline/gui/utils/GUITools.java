...
public class GUITools {
  ...
  /**
   * Определение компонентам размера самого большого (по ширине) компонента в группе Метод придания
   * группе компонентов одинаковых размеров (минимальных, предпочтительных и максимальных).
   *
