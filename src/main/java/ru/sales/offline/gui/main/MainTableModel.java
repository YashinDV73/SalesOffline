    ...
    static {
        ...
        tableColumns.add(
                TableColumn.<String>builder()
                        ...
                        .build());
        tableColumns.add(
                TableColumn.<Integer>builder().id(COLUMN_QTY).name("Кол-во").size(100).editable(true).defaultValue(1).aClass(Integer.class).build());
        tableColumns.add(
                TableColumn.<BigDecimal>builder().id(COLUMN_COST).name("Цена").size(150).editable(true).defaultValue(new BigDecimal(0)).aClass(BigDecimal.class).build());
        tableColumns.add(
        ...
        tableColumns.add(
                TableColumn.<MethodCalculationType>builder()
                        ...
                        .build());
        tableColumns.add(
                TableColumn.<BigDecimal>builder()
                        .id(COLUMN_SUM)
                        .name("Сумма")
                        .size(200)
                        .editable(false)
